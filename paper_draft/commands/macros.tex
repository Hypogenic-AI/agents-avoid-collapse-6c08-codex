...
\newcommand{\inheritanceproxy}{\textsc{Recursive Inheritance Proxy}\xspace}
\newcommand{\truthfulqa}{\textsc{TruthfulQA}\xspace}
\newcommand{\oasst}{\textsc{OASST1}\xspace}
\newcommand{\wikitext}{\textsc{WikiText-103 Raw}\xspace}
